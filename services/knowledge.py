...
def get_wound_care_guide():
    ...
    message = (
        ...
        "  ▫️ แผลแห้ง: วันละ 1-2 ครั้ง\n"
        "  ▫️ แผลมีน้ำซึม: เปลี่ยนเมื่อเปียก\n"
        "  ▫️ หลังอาบน้ำ: เปลี่ยนทันที\n\n"
...
def get_physical_therapy_guide():
    ...
    message = (
        ...
        "  ▫️ ป้องกันข้อติด กล้ามเนื้ออ่อนแรง\n"
        "  ▫️ ลดอาการปวด บวม\n"
        "  ▫️ กลับมาใช้ชีวิตได้ปกติเร็วขึ้น\n\n"
        
        "📅 กำหนดการออกกำลังกาย\n\n"
        
        "🔹 สัปดาห์ที่ 1-2 (หลังผ่าตัด)\n"
        "  ▫️ งอ-เหยียดข้อเท้า 10 ครั้ง/ชม.\n"
        "  ▫️ หายใจเข้าลึกๆ 5 ครั้ง/ชม.\n"
        "  ▫️ เปลี่ยนท่านอนทุก 2 ชม.\n"
        "  ▫️ ลุกนั่งข้างเตียงเมื่อแพทย์อนุญาต\n\n"
        
        "🔹 สัปดาห์ที่ 3-4\n"
        "  ▫️ เดินในบ้าน 5-10 นาที วันละ 2-3 ครั้ง\n"
        "  ▫️ ยกขาตรง 10 ครั้ง x 3 เซ็ต\n"
        "  ▫️ งอเข่า 90° 10 ครั้ง x 3 เซ็ต\n"
        "  ▫️ ขึ้น-ลงบันได (ถ้าพร้อม)\n\n"
        
        "🔹 สัปดาห์ที่ 5 เป็นต้นไป\n"
        "  ▫️ เดิน 20-30 นาที/วัน\n"
        "  ▫️ ออกกำลังกายเบา (ว่ายน้ำ, ปั่นจักรยาน)\n"
        "  ▫️ หลีกเลี่ยงกิจกรรมที่หักโหม\n\n"
        
        "⚠️ ข้อควรระวัง\n"
        "  ▫️ ถ้าปวดมากให้หยุดทันที\n"
        "  ▫️ เริ่มช้าๆ เพิ่มเป็นลำดับ\n"
        "  ▫️ ไม่แบกของหนัก 4-6 สัปดาห์แรก\n"
        "  ▫️ สวมรองเท้าที่มีพื้นกันลื่น\n\n"
...
def get_dvt_prevention_guide():
    ...
    message = (
        ...
        "  ▫️ นอนติดเตียงนาน\n"
        "  ▫️ อ้วน, สูงอายุ\n"
        "  ▫️ สูบบุหรี่, คุมกำเนิด\n"
        "  ▫️ ประวัติเคยเป็น DVT\n\n"
...
def get_medication_guide():
    ...
    message = (
        ...
        "1️⃣ ทานตรงเวลา\n"
        "  ▫️ ตั้งนาฬิกาปลุก\n"
        "  ▫️ ทานเวลาเดียวกันทุกวัน\n"
        "  ▫️ ห้ามข้ามมื้อ\n\n"
        
        "2️⃣ ทานตามที่แพทย์สั่ง\n"
        "  ▫️ ห้ามเพิ่ม-ลดขนาดยาเอง\n"
        "  ▫️ ห้ามหยุดยาเอง แม้อาการดีขึ้น\n"
        "  ▫️ อ่านฉลากยาทุกครั้ง\n\n"
        
        "3️⃣ ทานกับอาหารหรือไม่\n"
        "  ▫️ ยาบางชนิดต้องทานกับอาหาร\n"
        "  ▫️ ยาบางชนิดต้องทานท้องว่าง\n"
        "  ▫️ สอบถามเภสัชกรให้ชัดเจน\n\n"
        
        "📋 ยาที่มักสั่งหลังผ่าตัด\n\n"
        
        "🔸 ยาแก้ปวด\n"
        "  ▫️ ทานเมื่อปวด หรือตามเวลา\n"
        "  ▫️ ห้ามทานท้องว่าง\n"
        "  ▫️ ถ้าปวดมากแต่ยาไม่หาย → โทรหาแพทย์\n\n"
        
        "🔸 ยาปฏิชีวนะ\n"
        "  ▫️ ต้องทานให้ครบหมด!\n"
        "  ▫️ ห้ามหยุดเองแม้อาการดีขึ้น\n"
        "  ▫️ ทานตรงเวลา ทุก 6-8-12 ชม.\n\n"
        
        "🔸 ยาป้องกันลิ่มเลือด\n"
        "  • ทานตรงเวลา\n"
        "  ▫️ ระวังฟกช้ำง่าย เลือดออกง่าย\n"
        "  ▫️ แจ้งแพทย์ก่อนถอนฟัน/ผ่าตัดอื่น\n\n"
        
        "🔸 ยาลดกรด\n"
        "  ▫️ ทานก่อนอาหาร 30-60 นาที\n"
        "  ▫️ ลดอาการแสบท้อง\n"
        "  ▫️ ห้ามนอนทันทีหลังทาน\n\n"
        
        "⚠️ ผลข้างเคียงที่ควรระวัง\n"
        "  ▫️ คลื่นไส้ อาเจียน มาก\n"
        "  ▫️ ผื่นคัน บวม\n"
        "  ▫️ หายใจลำบาก\n"
        "  ▫️ เลือดออกง่าย\n"
...
def get_warning_signs_guide():
    ...
    message = (
        ...
        "  ▫️ ใจเต้นเร็ว >120 ครั้ง/นาที\n\n"
        
        "3️⃣ เลือดออกมาก\n"
        "  ▫️ แผลเปิดเลือดไหลไม่หยุด\n"
        "  ▫️ อาเจียนเป็นเลือด\n"
        "  ▫️ ถ่ายดำมาก\n"
        "  ▫️ ปัสสาวะเป็นเลือด\n\n"
        
        "4️⃣ อาการทางสมอง\n"
        "  ▫️ มึนงง สับสน พูดไม่ชัด\n"
        "  ▫️ เห็นภาพหลอน\n"
        "  ▫️ ชักหรือหมดสติ\n"
        "  ▫️ แขนขาอ่อนแรงเฉียบพลัน\n\n"
        ...
        "7️⃣ ปัญหาแผล\n"
        "  ▫️ แผลแยก เปิดกว้าง\n"
        "  ▫️ เห็นเนื้อเยื่อข้างใน\n"
        "  ▫️ แผลไม่หาย >2 สัปดาห์\n"
        "  ▫️ แผลดำ เนื้อตาย\n\n"
        
        "8️⃣ ลิ่มเลือด (DVT)\n"
        "  ▫️ ขาบวม ปวด แดง ร้อน\n"
        "  ▫️ ขาข้างเดียวบวมมากกว่าอีกข้าง\n"
        "  ▫️ เส้นเลือดโป่ง แข็ง\n\n"
        
        "🟡 ระดับ 3: ควรติดตาม (นัดพบแพทย์)\n\n"
        
        "9️⃣ อาการผิดปกติอื่นๆ\n"
        "  ▫️ คลื่นไส้ อาเจียน ไม่หาย\n"
        "  ▫️ ท้องผูก >3 วัน\n"
        "  ▫️ ปวดท้องมาก\n"
        "  ▫️ น้ำหนักลด >5 กก./เดือน\n\n"
